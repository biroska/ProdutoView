...
//	console.log("getSnapshot.scriptcam", $.scriptcam );
//	console.log("getSnapshot.base64Image", $.scriptcam.getFrameAsBase64() );
	...
	<div class="panel panel-info center-block" >
		...
		<div class="row-fluid show-grid">
			...
			<div class="col-xs-6 col-sm-6 col-md-4" style="background-color:red;">
				<div class="row-fluid" style="height: 240px; text-align: center">
               		<div id="camera"></div>
               		<div id="snapshotDiv">
               	...
               	<div class="row-fluid lineHeight" style="text-align: center;">
                	...
                	<button id="anotherImageButton" type="button" class="btn btn-default" onclick="hideSnapshot();" >Capturar Outra Imagem</button>
               	</div>
        	</div>
		</div>
		</div>
